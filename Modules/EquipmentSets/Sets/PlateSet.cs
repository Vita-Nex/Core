...
namespace VitaNex.Modules.EquipmentSets
{
	public sealed class PlateArmorSet : EquipmentSet
	{
			...
			: base("Plate Avenger")
		{
			...
			Add(new StatOffsetSetMod("PlateAvenger1", "Avenger I", 2, true, StatType.All, 5, TimeSpan.Zero));
			Add(new StatOffsetSetMod("PlateAvenger2", "Avenger II", 4, true, StatType.All, 5, TimeSpan.Zero));
			Add(new StatOffsetSetMod("PlateAvenger3", "Avenger III", 6, true, StatType.All, 5, TimeSpan.Zero));
		}
	}
}
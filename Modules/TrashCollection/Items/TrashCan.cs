...
namespace VitaNex.Modules.TrashCollection
{
	...
	public class TrashCan : BaseTrashContainer
	{
		...
		{
			"*Nom Nom Nom*", "*Burp*", "I Like Trash", "*Brofist*",
			"That's What SHE Said!", "I Have No Bottom, I Do Not Poop", "That Tickles!", "I Cast Thy trash Into The Abyss!",
			"Trash, Be Gone!", "*Boing*", "*Poof*", "Ha Ha, Made You Look", "It's Gone, Into The Void",
			"Have You Seen My Brothers?", "Your Trash Was Trashed, Heh", "*Weeeeeeeeeee... Thud*"
		};

		public static string[] FailEmotes =
		{
			"Ewww", "Thanks, But No Thanks", "Are You Hitting On Me?", "Disgusting!",
			"Not My Kind Of Food", "I've Had That Before, It's Terrible", "Please! No!", "Pfft, You Eat It, If It's Sooo Good",
